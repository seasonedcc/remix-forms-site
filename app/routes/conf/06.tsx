...
export default function Component() {
  ...
  return (
    ...
    >
      <div>
        <Label id="label-for-" htmlFor="city">City</Label>
      ...
      <div className="flex w-full space-x-4">
        <div className="flex-1">
          <Label id="label-for-" htmlFor="checkIn">Check In</Label>
          <Input {...register('checkIn')} id="checkIn" type="date" />
          {renderError('checkIn', errors)}
        </div>
        <div className="flex-1">
          <Label id="label-for-" htmlFor="checkOut">Check Out</Label>
      ...
      <div className="flex w-full space-x-4">
        <div className="flex-1">
          <Label id="label-for-" htmlFor="adults">Adults</Label>
          <Input {...register('adults')} id="adults" />
          {renderError('adults', errors)}
        </div>
        <div className="flex-1">
          <Label id="label-for-" htmlFor="children">Children</Label>
          <Input {...register('children')} id="children" />
          {renderError('children', errors)}
        </div>
        <div className="flex-1">
          <Label id="label-for-" htmlFor="bedrooms">Bedrooms</Label>
          <Input {...register('bedrooms')} id="bedrooms" />
          {renderError('bedrooms', errors)}
        </div>
      </div>
      <div>
        <Label id="label-for-" htmlFor="specialRequests">Special Requests</Label>
...
function serverErrorFor(name: string) {
  const errors = useActionData<ActionData>()?.errors
  return errors?.find(({ path }) => path[0] === name)?.message
}

function renderServerError(name: string) {
  const message = serverErrorFor(name)
